...
public class DBConstants {
    ...
    public static  final String GET_VEHICULE_NUMBER = "select vehicleRegNumber form ticket";
    public static final String COUNT_VISITS = "select count(VEHICLE_REG_NUMBER) from ticket where VEHICLE_REG_NUMBER=?";
}
